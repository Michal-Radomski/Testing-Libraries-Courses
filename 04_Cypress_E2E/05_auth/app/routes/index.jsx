  ...
  return (
    <>
      <section className="text-center max-w-5xl mx-auto my-4">
        ...
        <p>Manage your key Cypress takeaways and concepts with our learning app.</p>
      </section>
      <section className="text-center max-w-5xl mx-auto my-4">
      ...
      <section>
        <p className="text-center">
          <Link to="/takeaways/new" className="bg-blue-700 text-blue-50 rounded-sm px-8 py-4 text-lg hover:bg-blue-600">
            + Add a new takeaway
          </Link>
        </p>
      </section>
