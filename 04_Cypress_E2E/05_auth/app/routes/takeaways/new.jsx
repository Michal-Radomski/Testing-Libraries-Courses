...
function NewTakewayRoute() {
  ...
  return (
    <Modal onClose={() => navigate("..", { relative: "path" })}>
      <Form method="post">
        <p>
          <label htmlFor="title" className="block mb-1 font-semibold text-slate-600">
            Title
          </label>
          <input
            type="text"
        ...
        <p>
          <label htmlFor="body" className="block mb-1 font-semibold text-slate-600">
            Body
          </label>
          <textarea id="body" name="body" required rows={5} className="px-2 py-1 bg-slate-200 w-full" data-cy="body" />
        </p>
